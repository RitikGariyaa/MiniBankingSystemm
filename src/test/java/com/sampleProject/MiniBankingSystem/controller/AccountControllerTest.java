...
import com.sampleProject.MiniBankingSystem.model.*;
...
class AccountControllerTest {
    ...
    @Test
    @DisplayName("GET /api/accounts/{id} returns account")
    ...
    @Test
    @DisplayName("POST /api/accounts creates account")
    ...
    @Test
    @DisplayName("POST /api/accounts/{id}/deposit deposits funds")
    void deposit_ok() throws Exception {
        ...
        mockMvc.perform(post("/api/accounts/5/deposit")
                        .contentType(MediaType.APPLICATION_JSON)
                        .content(json))
                .andExpect(status().isOk())
